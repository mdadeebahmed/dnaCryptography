                ...
                <div class="container my-5 py-5 px-lg-5">
                    <div class="row g-5">
                        <div class="col-lg-6 pt-5 text-center text-lg-start">
                            <h1 class="display-4 text-white mb-4 animated slideInLeft">RECEIVER LOGIN</h1>
                       ...
                       <form action="ReceiverAction.jsp" method="post">
                            ...
                            <a href="ReceiverReg.jsp" class="btn btn-secondary py-sm-3 px-sm-5 me-3 animated slideInLeft">REGISTER Here</a>
                        </div>
