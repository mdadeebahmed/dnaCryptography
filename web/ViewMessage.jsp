                ...
                <div class="row justify-content-center">
                    <div class="col-lg-10">
                        <div class="section-title position-relative text-center mx-auto mb-4 pb-4 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                            <h1 class="mb-3">VERIFY KEY</h1>
                            <p class="mb-1"></p>
                        </div>
                        <div class="position-relative w-100 my-3 wow fadeInUp" data-wow-delay="0.3s">
                            <center>
                     
                               <form action="DecodeVerify.jsp" method="post">
                            <table>
                           
                                       
                        <tr><th>Decode Key</th><td><input type="text" name="decode" required=""></td></tr>
                        <tr><th></th><td><input type="submit" value="VERIFY KEY"></td></tr>
                            </table>
                            </form>                                
