            ...
            <div class="container px-lg-5">
                <div class="row justify-content-center">
                    <div class="col-lg-10">
                        ...
                        String ascii=ConvertStringToAscii.convertToAscii(message);
                      
                        %>
                        <div class="position-relative w-100 my-3 wow fadeInUp" data-wow-delay="0.3s">
                        <center>
                            <form action="ConvertHexaDecimal.jsp" method="post">
                            <table>
                        ...
                        <tr><th></th><td><input type="submit" value="Convert HexaDecimal"></td></tr>
                            </table>
                            </form>
                        </center>
