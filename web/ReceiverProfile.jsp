            ...
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
               ...
               <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <a href="ReceiverProfile.jsp" class="nav-item nav-link active">View Profile</a>
                        <a href="ViewMessage.jsp" class="nav-item nav-link">View Message</a>
                    
                        
                        <a href="#" class="nav-item nav-link"></a>
                    </div>
                   
                    <a href="Receiver.jsp" class="btn btn-secondary py-2 px-4 ms-3">Logout</a>
                </div>
            </nav>
<%
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-10">
                        ...
                        <table border="1">
                                                            ...
                                                            <%try{
                                                               String  sql="select * from receiver where email='"+email+"'";
