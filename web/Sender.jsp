                ...
                <div class="container my-5 py-5 px-lg-5">
                    <div class="row g-5">
                        <div class="col-lg-6 pt-5 text-center text-lg-start">
                            <h1 class="display-4 text-white mb-4 animated slideInLeft">SENDER LOGIN</h1>
                            <p class="text-white animated slideInLeft">
                             
                       <form action="SenderLogAction.jsp" method="post">
                                                                <table>
                                                          ...
                                                          <tr><th>Don't Have An Account? </th></tr>
                                                                </table> 
                                                            </form>
                            </p>
                            ...
                            <a href="SenderUserReg.jsp" class="btn btn-secondary py-sm-3 px-sm-5 me-3 animated slideInLeft">REGISTER Here</a>
                        </div>
