            ...
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <a href="SendMessage.jsp" class="nav-item nav-link active">DNA Encode</a>
            ...
            <div class="container px-lg-5">
                <div class="row justify-content-center">
                    <div class="col-lg-10">
                        ...
                        <center>
                            <form action="ConvertAscii.jsp" method="post">
                            <table>
                           
                                        <tr><th>Select Receiver</th><td><select name="remail">
                                                    <%try{
                                                        ResultSet s=Queries.getExecuteQuery("select * from receiver");
                                                        while(s.next()){
                                                    %>
                                                    <option><%=s.getString("email")%></option>
                                                   <%}
}catch(Exception e){
                        ...
                        <tr><th></th><td><input type="submit" value="Convert Ascii"></td></tr>
                            </table>
                            </form>
                        </center>
