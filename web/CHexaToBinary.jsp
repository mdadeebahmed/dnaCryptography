...
<body>
    <div class="container-xxl bg-white p-0">
            ...
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <a href="CHexaToBinary.jsp" class="nav-item nav-link active">HexaDecimal To Binary</a>
                        <a href="BinaryToDNA.jsp" class="nav-item nav-link">Binary To DNA</a>
        ...
        <!-- Navbar & Hero End -->
        <center>
<h1 class="mb-3" style="margin-bottom:500px;"> HEXADECIMAL TO BINARY</h1>
<table>
    <tr>
        <th>Sender</th>
        <th>Receiver</th>
    ...
    while(r.next()){
        ...
        <tr>
            ...
            <td><textarea cols="30" rows="5" style="color:red;"><%=r.getString("binary")%></textarea></td>
