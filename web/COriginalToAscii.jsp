...
<body>
    <div class="container-xxl bg-white p-0">
            ...
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <a href="COriginalToAscii.jsp" class="nav-item nav-link active">Original to ASCii</a>
        ...
        <!-- Navbar & Hero End -->
        <center>
<h1 class="mb-3" style="margin-bottom:500px;">TEXT TO ASCII</h1>
<table>
    <tr>
        <th>Sender</th>
        <th>Receiver</th>
    ...
    while(r.next()){
        ...
        <tr>
            ...
            <td style="color:red;"><%=r.getString("ascii")%></td>
