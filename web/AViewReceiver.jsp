            ...
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <a href="AViewSender.jsp" class="nav-item nav-link ">View Sender</a>
                        <a href="AViewReceiver.jsp" class="nav-item nav-link active">View Receiver</a>
                    
                        
                        <a href="#" class="nav-item nav-link"></a>
                    </div>
                   
                    <a href="Admin.jsp" class="btn btn-secondary py-2 px-4 ms-3">Logout</a>
                </div>
            </nav>
                ...
                <div class="container my-5 py-5 px-lg-5">
                    <div class="row g-5">
                        <div class="col-lg-6 pt-5 text-center text-lg-start">
                            ...
                            <a href="" class="btn btn-secondary py-sm-3 px-sm-5 me-3 animated slideInLeft">VIEW DETAILS</a>
                        </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-10">
                        <div class="section-title position-relative text-center mx-auto mb-4 pb-4 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                            <h1 class="mb-3">VIEW RECEIVER DETAILS</h1>
                            <p class="mb-1"></p>
                        </div>
                                                                ...
                                                                while(r.next()){
                                                                 ...
                                                                 <tr>
                                                                     ...
                                                                     <td><%=r.getString("address")%></td>
                                                                            <%if(s.equals("waiting")){%>
                                                                         <td><a href="ARAuthorize.jsp?id=<%=r.getString("id")%>" style="color:red;">Authorize</a></td>
                                                                    <%}else{%>
                                                                    <td><%=s%></td>
                                                                    <%}%>
                                                                 </tr>   
