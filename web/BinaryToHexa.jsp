            ...
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        <a href="ReceiverHome.jsp" class="nav-item nav-link ">Home</a>
                        <a href="ReceiverProfile.jsp" class="nav-item nav-link">View Profile</a>
                        <a href="ViewMessage.jsp" class="nav-item nav-link active">View Message</a>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-10">
                        <div class="section-title position-relative text-center mx-auto mb-4 pb-4 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                            <h1 class="mb-3">VIEW ENCODED DNA AND DECODE MESSAGE</h1>
                            <p class="mb-1"></p>
                        </div>
                        ...
                        <table border="1">
                                                            ...
                                                            <%try{
                                                               ...
                                                               String  sql="select * from dna where id='"+idi+"'";
                                                                ...
                                                                while(r.next()){
                                                                 ...
                                                                 <tr>
                                                                     <td><%=r.getString("sender")%></td>
                                                                       <td><textarea cols="30" rows="5"><%=r.getString("dna")%></textarea></td>
                                                                        <td><textarea cols="30" rows="5"><%=r.getString("binary")%></textarea></td>
                                                                        <td><textarea cols="20" rows="3"><%=r.getString("hexa")%></textarea></td>
                                                                    <td><%=s%></td>
                                          
                                                                    <td><a href="HexaToAscii.jsp?id=<%=r.getString("id")%>">Convert Ascii</a></td>
                                                                 </tr>   
